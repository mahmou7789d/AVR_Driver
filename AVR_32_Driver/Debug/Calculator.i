...
# 9 "../APP/Calculator/Calculator.c" 2
...
# 10 "../APP/Calculator/Calculator.c" 2
...
# 12 "../APP/Calculator/Calculator.c" 2
...
# 13 "../APP/Calculator/Calculator.c" 2

uint_8 Keypad_array[4][4] = {{'7','8','9','A'},
                                 {'4','5','6','B'},
                                 {'1','2','3','C'},
                                 {'#','0','*','D'}};


Keypad_Data keypad1 = {((GPIO_Register *) ((0x19)+(0x20))), PIN0, PIN1, PIN2, PIN3, PIN4, PIN5,PIN6, PIN7};
Led_Data LED1 ={((GPIO_Register *) ((0x16)+(0x20))),PIN6,LED_FW_OFF};
