...
# 10 "../HAL/LCD_Screen/LCD.c" 2
static void Set_Enable_Bit()
{
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN2,HIGH);
 _delay_ms(2);
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN2,LOW);
 _delay_ms(2);
}
void LCD_Init(void)
{
 _delay_ms(200);
# 38 "../HAL/LCD_Screen/LCD.c"
 GPIO_Port_Configuration(((GPIO_Register *) ((0x16)+(0x20))),0XF0);
 GPIO_Pin_Configuration(((GPIO_Register *) ((0x16)+(0x20))),PIN0,OUTPUT);
 GPIO_Pin_Configuration(((GPIO_Register *) ((0x16)+(0x20))),PIN2,OUTPUT);
 GPIO_Pin_Configuration(((GPIO_Register *) ((0x16)+(0x20))),PIN1,OUTPUT);
 (((GPIO_Register *) ((0x13)+(0x20)))->PORT &= ~(1<<PIN1));
 _delay_ms(1);
 Send_Command_LCD(0x02);
 _delay_ms(1);
 Send_Command_LCD(0x28);
 _delay_ms(1);
 Send_Command_LCD(((0x08)|(1<<2)|(1<<1)|(1>>1)));
 _delay_ms(1);
 Send_Command_LCD(0x01);
 _delay_ms(10);
# 69 "../HAL/LCD_Screen/LCD.c"
}
void Send_Command_LCD(uint_8 Command)
{
 ...
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN0,LOW);
 Set_Enable_Bit();
 GPIO_Write_High_Nibble('B',Command<<4);
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN0,LOW);
 Set_Enable_Bit();
 _delay_ms(1);
# 96 "../HAL/LCD_Screen/LCD.c"
}
void Send_char_LCD(uint_8 Character)
{
 ...
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN0,HIGH);
 Set_Enable_Bit();
 GPIO_Write_High_Nibble('B',Character<<4);
 GPIO_Pin_Write(((GPIO_Register *) ((0x16)+(0x20))),PIN0,HIGH);
 Set_Enable_Bit();
 _delay_ms(1);
# 122 "../HAL/LCD_Screen/LCD.c"
}
void Move_Curser_LCD(uint_8 Row,uint_8 Column)
{
 ...
 switch(Row)
 {
  ...
  if (Column>0 && Column<=16)
   Address_Counter_Value=(0X80 +(Column-1));
  else
   Address_Counter_Value=0X80;
  Send_Command_LCD(Address_Counter_Value);
  break;
  case 2:
  if (Column>0 && Column<=16)
   Address_Counter_Value=(0XC0 +(Column-1));
  else
   Address_Counter_Value=0X80;
  Send_Command_LCD(Address_Counter_Value);
  break;
