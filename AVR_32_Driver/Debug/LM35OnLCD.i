...
# 1 "<command-line>"
# 1 "../APP/LM35 On LCD/LM35OnLCD.c"
# 9 "../APP/LM35 On LCD/LM35OnLCD.c"
# 1 "../APP/LM35 On LCD/LM35OnLCD.h" 1
# 12 "../APP/LM35 On LCD/LM35OnLCD.h"
...
void ADC_INT();
# 13 "../APP/LM35 On LCD/LM35OnLCD.h" 2
...
# 14 "../APP/LM35 On LCD/LM35OnLCD.h" 2
# 1 "../HAL/Tempreture_Sensor_LM35/LM35.h" 1
# 12 "../HAL/Tempreture_Sensor_LM35/LM35.h"
# 1 "../MCAL/ADC/ADC_file.h" 1
# 13 "../HAL/Tempreture_Sensor_LM35/LM35.h" 2
...
# 15 "../APP/LM35 On LCD/LM35OnLCD.h" 2

void LM35OnLCD_INIT();
void LM35OnLCD_Control();
# 10 "../APP/LM35 On LCD/LM35OnLCD.c" 2

ADC_Pin_Data ADC_PIN ={PIN0,ADC_Disabled_INT,2.56,ADC_Clk_64,FreeRunningMode,Adjust_Right};
void LM35OnLCD_INIT()
{
 LCD_Init();
 ADC_Init(ADC_PIN);
